  ...
  const entity = props.entityData;
    return(
        ...
        <div className="card-actions">
          <Button size="medium" variant="raised" color="primary" className="card-button" onClick={props.onClick}>
            Editar
          </Button>
        </div>
      </Card>
